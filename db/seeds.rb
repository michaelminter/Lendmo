...
#   Mayor.create(name: 'Emanuel', city: cities.first)
    ...
    Badge.create :name => 'Tenth Lend',     :image_uri => 'tenthlend_badge.png', 
                 :description => 'Ten Lends! You\'re almost power Lendmo lender!'
    ...
    Badge.create :name => 'Tenth Borrow',   :image_uri => 'tenthborrow_badge.png',
                 :description => 'Ten Borrows! You\'re almost a power Lendmo borrower!'
